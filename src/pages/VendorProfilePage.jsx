      ...
      <div className={styles.card}>
        <div className={styles.section}>
          <div className="form-group">
            ...
            <input className="form-input" placeholder="Agropecuária Central"
          ...
          <div className="grid-2">
            <div className="form-group">
              ...
              <input className="form-input" placeholder="(88) 99111-0001"
            ...
            <div className="form-group">
              ...
              <input className="form-input" placeholder="Ex: Tabuleiro do Norte"
